...
pretrained_resnet_file = "ResNet152_trained_FL_20181030_Adam.torch"   # need pretrained weights for nViewNet "nViewNet_ResNet152_Initial_Weights.torch"
resume_nViewNet_file = "nViewNet-8_simple_20181022.torch"  #if model_to_train == nViewNet_resume specify file name here

# Experiment Parameters
n_class = 14  # 1-11; 14 for ML_215
...
batchsize_top = 32
batchsize_all = 16
epochs_top = 25 # number of epochs to train the top of the model
...
#test_infile  = 'test_infile_ML_215.txt'
#train_infile = 'train_infile_20180828.txt'
#test_infile  = 'test_infile_20180828.txt'
train_infile = 'train_infile_one.txt'
test_infile  = 'test_infile_one.txt'
#
# Print Configs

if model_to_train == "ResNet152":
    configs = "{}_LRtop_{}_LRall_{}_Momentum_{}".format(model_to_train, lr_top, lr_all, momentum)
elif model_to_train == "nViewNet":
    configs = "{}-{}_LRtop_{}_LRall_{}_Momentum_{}".format(model_to_train, n_views, lr_top, lr_all, momentum)
...
if __name__ == "__main__":
    ...
    test_data = MeshTrainDataset(test_infile, nview_len = n_views, ann_ones_based = True )
